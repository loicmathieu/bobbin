...
/**
 * dialog for editing thread filters.
 * @author irockel
 */
public class EditThreadFilterDialog extends JDialog {
	 ...
	 */
	public EditThreadFilterDialog(Frame owner, String frameTitle, JList filterList, boolean isAdd) {
	...
	private void initPanel() {
		settingsPanel = new SettingsPanel(!isAdd ? (ThreadFilter) filterList.getSelectedValue() : null);
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!isAdd) {
					ThreadFilter filter = (ThreadFilter) filterList.getModel().getElementAt(filterList.getSelectedIndex());
					applyFilter(filter);
	...
	private void applyFilter(ThreadFilter filter) {
	...
	private void addToList(ThreadFilter filter) {
	...
	class SettingsPanel extends JPanel {
		...
		public SettingsPanel(ThreadFilter presetFilter) {
		 ...
		 */
		private void fillFilterData(ThreadFilter presetFilter) {
		 ...
		 */
		public ThreadFilter getAsFilter() {
			ThreadFilter newFilter = new ThreadFilter(filterName.getText(),
